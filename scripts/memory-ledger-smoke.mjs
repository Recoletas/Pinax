...
try {
  ...
  // c445dd4 起工作区默认视图是「修改记录」；事实账本是显式页签。
  await workspace.getByRole('button', { name: '事实账本' }).click()
  ...
  await ledgerSection.getByLabel('视图').selectOption('facts')
  ...
  await ledgerSection.getByLabel('视图').selectOption('decisions')
