/*
 * Verbatim reference copy of the Oh Story story-review degeneration detector.
 * Upstream: https://github.com/zenstory-ai/oh-story-claudecode
 * Revision: 0ffe7db4fa02489f5d1989e58a22ce62d040a850
 * Path:     skills/story-review/scripts/check-degeneration.js
 * License:  MIT — see public/third-party/oh-story-claudecode-LICENSE.txt
 * Only this header was added; the code below is byte-identical to upstream
 * (renamed to .cjs because Pinax is a "type": "module" package).
 * It is a test fixture for scripts/writing-skills-degeneration-eval.mjs and
 * must NOT be imported by application code (frontend stays fs/CLI-free).
 */
// [pinax] shebang removed: fixture is spawned via `node`, not executed directly.
'use strict';
