...
下一轮执行入口：[第四轮夜间任务书](./plan/authoring-overnight-round4-20260908.md)。以[人物 IF 补充调研](./plan/authoring-character-fate-followup-20260908.md)为依据，建议单信念人物 IF 主原型，先补上轮安全/追加要求/保稿；U 10 包、K 8 包及 6 加深任务覆盖可玩闭环、薄对象引用、提炼候选和组合验收。空间/回溯不并开正式主线；实际续接启动门槛通过前仍为待执行。
