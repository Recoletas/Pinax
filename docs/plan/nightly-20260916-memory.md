...
> 2026-09-17 当前状态：A首批已提交 `aa17b47`，尚未组合验收。**继续执行请读[48项续跑任务](./nightly-20260917-memory-continuation.md)与[ABC无O调度](./nightly-20260917-ac-dispatch.md)**；下文保留首批调研/规格，不再以首批P0作为整线终点。
> 历史编制基线为 `f74545b`，实际首批执行基线为 `b5b2b56`。旧文中O夜间接线职责已分给ABC，冲突时以9月17日修订为准。
