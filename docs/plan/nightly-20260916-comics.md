...
状态：本文件为2026-09-16编制的B线规格，实际执行进度以B工作树和回执为准。**2026-09-17用户取消夜间O线**，B增加公共UI/media/package/许可接线职责与BX01–BX12，详见[ABC调度修订](./nightly-20260917-ac-dispatch.md)。原文禁止B写这些共享文件的限制，仅在修订明确列出的窄写集内解除；不得扩大为全站重写。
