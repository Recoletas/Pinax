    ...
    <div class="pe-main" :data-mobile-pane="mobilePane" :data-canvas-surface="canvasSurface">
      ...
      <aside class="left-panel">
        ...
        <CanvasTimeline
          ...
          @open-video="directorExportController.handoff"
        />
      </aside>
...
function handleDirectorTimelineAction() {
  ...
  void directorExportController.prepare()
}
...
const directorExportController = useProseDirectorExport({
  prepareVersion: prepareDirectorStoryboardVersion,
  openVideoPanel: openStoryboardVideoPanel
})
...
<style scoped src="./ProseEssay.scoped.css"></style>
