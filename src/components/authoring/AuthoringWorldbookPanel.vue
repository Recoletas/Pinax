      ...
      <template v-if="worldbook && selectedEntry">
        ...
        <div class="setting-sheet__scroll">
          ...
          <div class="setting-row">
            ...
            <label><span>分组</span><input v-model="draft.group" @blur="flushSave" /></label>
          </div>
